package es.caib.evidenciesib.persistence.test;
...
import es.caib.evidenciesib.persistence.EvidenciesIBJPADaoManagers;
import es.caib.evidenciesib.model.EvidenciesIBDaoManager;
...
public class TestPersistenceJPA {
    ...
    public static final void main(String[] args) {
        try {
            ...
            */
            ...
            IPluginManager pluginMan = EvidenciesIBDaoManager.getDaoManagers().getPluginManager();
            ...
            */
             ...
             * IIdiomaManager idioma = EvidenciesIBDaoManager.getDaoManagers().getIdiomaManager();
             * 
    ...
    public static EntityManager initDB() {
        ...
        prop.put("javax.persistence.jdbc.url", "jdbc:postgresql://localhost:5432/evidenciesib");
        prop.put("javax.persistence.jdbc.user", "evidenciesib");
        prop.put("javax.persistence.jdbc.password", "evidenciesib");

        prop.put("hibernate.connection.driver_class", "org.postgresql.Driver");
        prop.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/evidenciesib");
        prop.put("hibernate.connection.username", "evidenciesib");
        prop.put("hibernate.connection.password", "evidenciesib");
        ...
        emf = Persistence.createEntityManagerFactory("evidenciesibPULocal", prop);

        EntityManager em = emf.createEntityManager();

        em.setFlushMode(FlushModeType.AUTO);
        
        EvidenciesIBDaoManager.setDaoManagers(new EvidenciesIBJPADaoManagers(em)); 
