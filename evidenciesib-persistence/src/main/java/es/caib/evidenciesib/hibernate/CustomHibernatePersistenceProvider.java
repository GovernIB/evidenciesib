package es.caib.evidenciesib.hibernate;
		...
		if(fitxerProperties != null) {
			fitxerProperties.forEach((k,v) -> {
               String kStr = k.toString();
	        	if (kStr.startsWith("es.caib.evidenciesib.hibernate")) {
	        		projecteProperties.put(kStr.replace("es.caib.evidenciesib.",""), v.toString());
