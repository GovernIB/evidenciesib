...
public class TraduccioBeanValidator 
  ...
  // EJB's
  protected final es.caib.evidenciesib.model.dao.ITraduccioManager __traduccioManager;


  public final TraduccioValidator<TraduccioJPA> _validator;


  public TraduccioBeanValidator(es.caib.evidenciesib.model.dao.ITraduccioManager __traduccioManager) { 
  ...
  public TraduccioBeanValidator(TraduccioValidator<TraduccioJPA> _validator,
     es.caib.evidenciesib.model.dao.ITraduccioManager __traduccioManager) {
    this.__traduccioManager = __traduccioManager;
