...
@Table(name = "evi_traducciomap" , indexes = { 
        @Index(name="evi_traducciomap_pk_i", columnList = "traducciomapid"),
        @Index(name="evi_traducciomap_idiomaid_fk_i", columnList = "idiomaid")})
