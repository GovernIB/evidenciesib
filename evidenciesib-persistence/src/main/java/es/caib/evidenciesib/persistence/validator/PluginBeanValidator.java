...
public class PluginBeanValidator 
  ...
  // EJB's
  protected final es.caib.evidenciesib.model.dao.IPluginManager __pluginManager;


  public final PluginValidator<PluginJPA> _validator;


  public PluginBeanValidator(es.caib.evidenciesib.model.dao.IPluginManager __pluginManager) { 
  ...
  public PluginBeanValidator(PluginValidator<PluginJPA> _validator,
     es.caib.evidenciesib.model.dao.IPluginManager __pluginManager) {
    this.__pluginManager = __pluginManager;
