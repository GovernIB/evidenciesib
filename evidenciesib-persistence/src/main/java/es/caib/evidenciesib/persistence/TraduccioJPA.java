...
@Table(name = "evi_traduccio" , indexes = { 
        @Index(name="evi_traduccio_pk_i", columnList = "traduccioid")})
@SequenceGenerator(name="TRADUCCIO_SEQ", sequenceName="evi_traduccio_seq", allocationSize=1, initialValue=1000)
...
public class TraduccioJPA implements Traduccio {
  ...
  @ElementCollection(fetch= FetchType.EAGER, targetClass = es.caib.evidenciesib.persistence.TraduccioMapJPA.class)
  @Cascade(value=org.hibernate.annotations.CascadeType.ALL)
  @LazyCollection(value= LazyCollectionOption.FALSE)
  @JoinTable(name="evi_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")}, foreignKey=@ForeignKey(name="evi_traducmap_traduccio_fk"))
  @javax.persistence.MapKeyColumn(name="idiomaid")
  private Map<String, es.caib.evidenciesib.persistence.TraduccioMapJPA> traduccions =  new HashMap<String, es.caib.evidenciesib.persistence.TraduccioMapJPA>();

  public Map<String, es.caib.evidenciesib.persistence.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, es.caib.evidenciesib.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public es.caib.evidenciesib.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (es.caib.evidenciesib.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, es.caib.evidenciesib.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
