...
@Table(name = "evi_idioma" , indexes = { 
        @Index(name="evi_idioma_pk_i", columnList = "idiomaid")})
@SequenceGenerator(name="IDIOMA_SEQ", sequenceName="evi_idioma_seq", allocationSize=1, initialValue=1000)
