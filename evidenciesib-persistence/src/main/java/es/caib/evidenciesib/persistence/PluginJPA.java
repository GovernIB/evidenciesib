...
@Table(name = "evi_plugin" , indexes = { 
        @Index(name="evi_plugin_pk_i", columnList = "pluginid")})
@SequenceGenerator(name="PLUGIN_SEQ", sequenceName="evi_plugin_seq", allocationSize=1, initialValue=1000)
...
public class PluginJPA implements Plugin {
  ...
  public PluginJPA(long pluginID , java.lang.String nom , java.lang.String descripcio , java.lang.String classe , int tipus , java.lang.String propietats , boolean actiu) {
  ...
  public PluginJPA(java.lang.String nom , java.lang.String descripcio , java.lang.String classe , int tipus , java.lang.String propietats , boolean actiu) {
    this.nom=nom;
    this.descripcio=descripcio;
    this.classe=classe;
    this.tipus=tipus;
