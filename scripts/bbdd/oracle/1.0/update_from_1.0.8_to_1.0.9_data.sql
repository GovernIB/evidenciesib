...
es.caib.evidenciesib.pluginsib.login.loginibswagger.pass=[=SP["es.caib.evidenciesib.pluginsib.login.loginibswagger.pass"]]', 1);



INSERT INTO evi_plugin(pluginid, nom, descripcio, classe, tipus, propietats, actiu) VALUES (evi_plugin_seq.nextval, 'Plugin de Login Mock', 'Plugin de Login Mock', 'es.caib.evidenciesib.pluginsib.login.class=org.fundaciobit.pluginsib.login.mock.PluginLoginMock', 1, '# Exemple de Persona Física
es.caib.evidenciesib.pluginsib.login.mock.logininfo={"username":"pfuster","name":"Pep","surname1":"Fuster","surname2":"Gonella","administrationID":"30000056Y","authenticationMethod":"None","qaa":1,"identityProvider":"MOCK","business":0}


# Exemple Persona Jurídica 1
#es.caib.evidenciesib.pluginsib.login.mock.logininfo={"username":"","name":"MyBusiness","administrationID":"87654321Z","authenticationMethod":"None","qaa":1,"identityProvider":"MOCK","business":0,"representative":{"name":"Pep","surname1":"Gonella","surname2":"Fuster","administrationID":"30000056Y"}}', 0);


INSERT INTO evi_plugin(pluginid, nom, descripcio, classe, tipus, propietats, actiu) VALUES (evi_plugin_seq.nextval, 'Plugin firma en Servidor Cridant Ws de PortaFIB', 'Plugin firma en Servidor Cridant Ws de PortaFIB', 'es.caib.evidenciesib.logic.firmaviaapi.PluginFirmaEnServidorViaApiPortaFIB', 2, '# Propietats per les Firmes Utilitzant Api Firma Simple en Servidor de PortaFIB 
...
es.caib.evidenciesib.apifirmaenservidor.defaultaliascertificate=afirmades-firma', 0);



INSERT INTO evi_plugin(pluginid, nom, descripcio, classe, tipus, propietats, actiu) VALUES (evi_plugin_seq.nextval, 'Plugin firma en Servidor Cridant WS d''UtilitatsFirma', 'Plugin firma en Servidor Cridant WS d''UtilitatsFirma', 'es.caib.evidenciesib.logic.firmaviaapi.PluginFirmaEnServidorViaApiUtilitatsFirma', 2, '# Propietats per les Firmes Utilitzant Api V2 d''UtilitatsFirma
...
# Configuració de Firma d´UtilitatsFirma té definit en el camp "Politica de Segell de Temps"
