...
<%
  ...
  String headerColorProp = Configuracio.getWebuiHeaderColor();
  String headerColorClass = "bg-aplicacio";
  String headerColorStyle = "";
  if (headerColorProp != null) {
      headerColorClass = "";
      headerColorStyle = "background-color: " + headerColorProp + ";";
  }

  %>
<header>
    <!-- Header -->
    <nav class="navbar navbar-expand-md navbar-dark fixed-top <%=headerColorClass %>" style="padding: 0;<%=headerColorStyle%>">
        ...
        <div class="navbar-brand menuGovern">
            ...
            <div>
                <h1 class="titol"><%=es.caib.evidenciesib.commons.utils.StaticVersion.PROJECT_NAME%></h1>
            </div>
            <div>
                <div>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav mobil">
                ...
                <li class="dropdown colorVerd">
                    ...
                    <button class="btn colorVerd dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown"
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                        <c:forEach var="idioma" items="${idiomes}" varStatus="status">
                            ...
                            <a class="dropdown-item" href="?lang=${idiomaID}">
                                ...
                                <img src="<c:url value="/img/${idiomaID}_petit_${lang eq idiomaID? 'on' : 'off'}.gif"/>" alt="${idiomaID}"
                                    style="margin-right: 0.5rem;" width="17" height="14" border="0" />${idioma.nom}
                            </a>
                        </c:forEach>
                ...
                <li class="dropdown colorVerd">
                    ...
                    <button class="btn colorVerd dropdown-toggle" type="button" id="dropdownMenu3" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">
