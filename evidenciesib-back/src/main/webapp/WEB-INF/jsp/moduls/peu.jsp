<%@page import="es.caib.evidenciesib.logic.utils.LogicUtils"%>
...
<footer id="footer">
    ...
    <div class="row mr-auto ml-3 mr-3 peuResponsive">
        ...
        <div class="col-4 pt-2 elementPeuResponsive">
            ...
            </strong> <br /> <small> Build: ${versio.buildTime} <br /> JDK: ${version.jdkVersion} <br /> <fmt:message key="revisio" />: <c:if
                    test="${empty versio.scmRevision}">
                    <fmt:message key="scmversion.msg" />
                </c:if> <c:if test="${not empty versio.scmRevision}">${versio.scmRevision}</c:if> <br /> <span style="padding-top: 2px"> <i><fmt:message
        ...
        <div class="col-4 text-center pt-2 text-decoration-none bg-transparent text-uppercase p-2 opcionsPeu elementPeuResponsive">
            ...
            <br />
            <a styleClass="text-dark linkPeu" href="<c:url value="/public/avislegal"/>">
                <fmt:message key="labels.avislegal" />
            </a>
        ...
        <div class="col-4 text-right">
            ...
            if (footerLogo == null) {
            %>
            <a href="#" style="padding-top: 10px" target="_blank">
                <img src="<c:url value="/img/fundaciobit-logo-peu.png"/>" />
            </a>
            <%
            } else {
            %>
            ...
            <small><a href="#modalAjuda" role="button" data-toggle="modal">
                    <fmt:message key="ajuda.necessitau" />
                </a></small>
        </div>
