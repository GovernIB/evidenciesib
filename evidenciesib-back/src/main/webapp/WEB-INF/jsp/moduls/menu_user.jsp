...
<div>
  <h5><fmt:message key="menu.user" /></h5>
...
--%>
   ...
   <sec:authorize access="hasAnyRole('ROLE_SOLI', 'ROLE_DEST', 'ROLE_COLA', 'ROLE_DELE')">
    ...
    <hr  style="margin-top: 6px;  margin-bottom: 6px;" />--%>
    <li style="list-style-type: disc; list-style-position: inside;">
      <a href="<c:url value="/user/evidencia/list"/>">
        <span style="${(fn:contains(url, '/user/evidencia'))? "font-weight: bold;" : ""}"><fmt:message key="evidencia.evidencia.plural" /></span>
      </a>
    </li>
