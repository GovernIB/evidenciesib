...
import es.caib.evidenciesib.back.validator.webdb.PluginWebValidator;
...
public class PluginController
  ...
  @EJB(mappedName = es.caib.evidenciesib.ejb.PluginService.JNDI_NAME)
  protected es.caib.evidenciesib.ejb.PluginService pluginEjb;
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public List<StringKeyValue> getReferenceListForTipus(HttpServletRequest request,
    ...
    __tmp.add(new StringKeyValue("1" , "Plugin Tipus Login Front"));
    __tmp.add(new StringKeyValue("2" , "Plugin Tipus Firma en Servidor"));
    return __tmp;
  }
