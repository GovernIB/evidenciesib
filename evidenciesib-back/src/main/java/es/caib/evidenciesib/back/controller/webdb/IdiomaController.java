...
import es.caib.evidenciesib.back.form.webdb.IdiomaForm;

import es.caib.evidenciesib.back.validator.webdb.IdiomaWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="idioma.idioma.plural", order=20, group=Tab.MENU_WEBDB)
@Controller
...
public class IdiomaController
    extends es.caib.evidenciesib.back.controller.EvidenciesIBBaseController<Idioma, java.lang.String> implements IdiomaFields {

  @EJB(mappedName = es.caib.evidenciesib.ejb.IdiomaService.JNDI_NAME)
  protected es.caib.evidenciesib.ejb.IdiomaService idiomaEjb;
