package es.caib.evidenciesib.back.config;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"es.caib.evidenciesib"})
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public LocaleResolver localeResolver() {
	    SessionLocaleResolver slr = new es.caib.evidenciesib.back.utils.EvidenciesIBSessionLocaleResolver();
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new es.caib.evidenciesib.back.security.DefaultRolesPrefixPostProcessor();
	}

	@Bean
	public MultipartResolver multipartResolver() {
		return new es.caib.evidenciesib.back.utils.EvidenciesIBCommonsMultipartResolver();
	}

	@Bean
	public HandlerExceptionResolver getFileSizeExceeds() {
	  return new es.caib.evidenciesib.back.utils.EvidenciesIBMaxUploadSizeExceededExceptionHandler();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/evidenciesib_genapp", "/WEB-INF/classes/genapp");
