 ...
 * 
 */
public class EvidenciesIBMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof EvidenciesIBMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof EvidenciesIBMaxUploadSizeExceededException) {
          msgCode = ((EvidenciesIBMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
