...
import es.caib.evidenciesib.back.form.webdb.TraduccioForm;

import es.caib.evidenciesib.back.validator.webdb.TraduccioWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="traduccio.traduccio.plural", order=40, group=Tab.MENU_WEBDB)
@Controller
...
public class TraduccioController
    extends es.caib.evidenciesib.back.controller.EvidenciesIBBaseController<Traduccio, java.lang.Long> implements TraduccioFields {
