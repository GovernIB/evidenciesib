...
import es.caib.evidenciesib.persistence.validator.FitxerValidator;
...
public class FitxerWebValidator extends AbstractWebValidator<FitxerForm, Fitxer>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = es.caib.evidenciesib.ejb.FitxerService.JNDI_NAME)
  protected es.caib.evidenciesib.ejb.FitxerService fitxerEjb;
