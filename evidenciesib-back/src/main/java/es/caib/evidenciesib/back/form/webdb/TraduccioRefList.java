...
import es.caib.evidenciesib.ejb.TraduccioService;
import org.fundaciobit.genapp.common.i18n.I18NException;
import es.caib.evidenciesib.model.fields.TraduccioFields;
...
public class TraduccioRefList extends RefListBase
  ...
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    List<es.caib.evidenciesib.model.entity.Traduccio> traduccions = traduccioEjb.select(where);
    ...
    for (es.caib.evidenciesib.model.entity.Traduccio traduccio : traduccions) {
      es.caib.evidenciesib.persistence.TraduccioJPA traduccioJPA = (es.caib.evidenciesib.persistence.TraduccioJPA) traduccio;
      String key = String.valueOf(traduccioJPA.getTraduccioID());
      es.caib.evidenciesib.persistence.TraduccioMapJPA _tm = traduccioJPA.getTraduccio(_lang);
      String value;
      if (_tm == null) {
