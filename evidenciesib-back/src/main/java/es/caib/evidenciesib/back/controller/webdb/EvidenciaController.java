 ...
 * @author GenApp
 */
@MenuOption(labelCode="evidencia.evidencia.plural", order=0, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Evidencia
   */
  @RequestMapping(value = "/cancel")
  public String cancelEvidencia(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "Evidencia_FilterForm_" + this.getClass().getName();
  }
