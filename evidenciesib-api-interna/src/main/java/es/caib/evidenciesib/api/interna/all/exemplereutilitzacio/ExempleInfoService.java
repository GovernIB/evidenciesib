package es.caib.evidenciesib.api.interna.all.exemplereutilitzacio;
...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de EvidenciesIB - Dades Obertes",
                description = "Exemple de Servei de Dades Reutilitzables emprant paginació i retorn complet de dades",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/evidenciesib/tree/evidenciesib-1.0/evidenciesib-api-interna-client-dadesobertes-v1"))
