package es.caib.evidenciesib.api.interna.all.exemplepublic;
...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de EvidenciesIB - Exemple de Servei Públic",
                description = "Conjunt de Serveis REST de EvidenciesIB per ser accedits públicament",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/evidenciesib/tree/evidenciesib-1.0/evidenciesib-api-interna-client-exemplepublic-v1"))
