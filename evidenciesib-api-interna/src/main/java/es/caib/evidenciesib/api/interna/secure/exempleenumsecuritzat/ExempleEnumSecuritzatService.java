package es.caib.evidenciesib.api.interna.secure.exempleenumsecuritzat;
...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de EvidenciesIB - Exemple de Servei Securitzat",
                description = "Conjunt de Serveis REST de EvidenciesIB per ser accedits emprant autenticació",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/evidenciesib/tree/evidenciesib-1.0/evidenciesib-api-interna-client-exemplesecure-v1"))
